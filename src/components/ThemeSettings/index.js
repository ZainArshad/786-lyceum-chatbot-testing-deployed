		...
		<ThemeSettingsButton>
			...
			>
				<Box p={2}>
					...
					>
						<MenuItem sx={{ fontWeight: 'bold' }} component={Link} href="/">
							Extended Sidebar
						</MenuItem>
						<MenuItem
							sx={{ fontWeight: 'bold' }}
							component={Link}
							href="/blueprints/accent-header/"
						>
							Accent Header
						</MenuItem>
						<MenuItem
							sx={{ fontWeight: 'bold' }}
							component={Link}
							href="/blueprints/accent-sidebar/"
						>
							Accent Sidebar
						</MenuItem>
						<MenuItem
						...
						<MenuItem
							sx={{ fontWeight: 'bold' }}
							component={Link}
							href="/blueprints/collapsed-sidebar/"
						>
							Collapsed Sidebar
						</MenuItem>
						<MenuItem
							sx={{ fontWeight: 'bold' }}
							component={Link}
							href="/blueprints/bottom-navigation/"
						>
							Bottom Navigation
						</MenuItem>
						<MenuItem
							sx={{ fontWeight: 'bold' }}
							component={Link}
							href="/blueprints/top-navigation/"
						>
							Top Navigation
						</MenuItem>
					</Menu>
